...
public enum StatsType {
    ...
    MINING_FORTUNE("mining_fortune", "マイニングフォーチュン", 0.0, false, StatsCategory.MINING),
    ORE_FORTUNE("ore_fortune", "鉱石フォーチュン", 0.0, false, StatsCategory.MINING),
    BLOCK_FORTUNE("block_fortune", "ブロックフォーチュン", 0.0, false, StatsCategory.MINING),
    DWARVEN_METAL_FORTUNE("dwarven_metal_fortune", "ドワーフ金属フォーチュン", 0.0, false, StatsCategory.MINING),
    GEMSTONE_FORTUNE("gemstone_fortune", "ジェムストーンフォーチュン", 0.0, false, StatsCategory.MINING),
